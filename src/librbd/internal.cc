...
#define READ_SIZE 4096
  ...
  rbd_image_qos_type_t get_qos_type(std::string qos_name) {
    if (qos_name.find("iops_read") != qos_name.npos) {
      return RBD_IMAGE_QOS_TYPE_IOPS_READ;
    } else if (qos_name.find("iops_write") != qos_name.npos) {
      return RBD_IMAGE_QOS_TYPE_IOPS_WRITE;
    } else if (qos_name.find("iops_rw") != qos_name.npos) {
  ...
  rbd_image_qos_key_t get_qos_key(std::string qos_name) {
    if (qos_name.find("limit") != qos_name.npos) {
      return RBD_IMAGE_QOS_KEY_AVG;
    } else if (qos_name.find("burst") != qos_name.npos) {
